...
public class AlexaRankingManager {
	...
	public Integer[] getAlexaRanking(String domain) {
		  
		Integer [] alexaRanks = new Integer[4];
	...
	public static void main(String args[]) {
		/*String url = "duwad.comn";
		AlexaRankingManager al = new AlexaRankingManager();
		Integer[] ranks = al.getAlexaRanking(url);
		for (int rank:ranks) {
